...
module.exports = function (options) {
  ...
  this.createmultisig = function (nrequired, array_of_public_keys, callback) {
    return process_request('createmultisig', [nrequired, array_of_public_keys], callback)
  }

  this.help = function (callback) {
    return process_request('help', [], callback)
  }

  this.validateaddress = function (address, callback) {
    return process_request('validateaddress', [address], callback)
  }

  this.walletlock = function (callback) {
    return process_request('walletlock', [], callback)
  }

  this.walletpassphrase = function (passphrase, timeout, callback) {
    return process_request('walletpassphrase', [passphrase, timeout], callback)
  }

  this.dumpwallet = function (dump_file_path, callback) {
    return process_request('dumpwallet', [dump_file_path], callback)
  }
